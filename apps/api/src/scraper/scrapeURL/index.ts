...
function buildFeatureFlags(
  ...
  // Menu modifier capture replays per-item endpoints inside the page session; aggregators
  // (DoorDash/UberEats) bot-wall the store-page load without stealth, so force it on.
